...
pub fn resolve_color_hex(color_name: &str) -> Option<&'static str> {
    let hex = match color_name {
        ...
        // Mauve
        "mauve-50" => "var(--color-mauve-50)", "mauve-100" => "var(--color-mauve-100)", "mauve-200" => "var(--color-mauve-200)", "mauve-300" => "var(--color-mauve-300)",
        "mauve-400" => "var(--color-mauve-400)", "mauve-500" => "var(--color-mauve-500)", "mauve-600" => "var(--color-mauve-600)", "mauve-700" => "var(--color-mauve-700)",
        "mauve-800" => "var(--color-mauve-800)", "mauve-900" => "var(--color-mauve-900)", "mauve-950" => "var(--color-mauve-950)",

        // Mist
        "mist-50" => "var(--color-mist-50)", "mist-100" => "var(--color-mist-100)", "mist-200" => "var(--color-mist-200)", "mist-300" => "var(--color-mist-300)",
        "mist-400" => "var(--color-mist-400)", "mist-500" => "var(--color-mist-500)", "mist-600" => "var(--color-mist-600)", "mist-700" => "var(--color-mist-700)",
        "mist-800" => "var(--color-mist-800)", "mist-900" => "var(--color-mist-900)", "mist-950" => "var(--color-mist-950)",

        // Olive
        "olive-50" => "var(--color-olive-50)", "olive-100" => "var(--color-olive-100)", "olive-200" => "var(--color-olive-200)", "olive-300" => "var(--color-olive-300)",
        "olive-400" => "var(--color-olive-400)", "olive-500" => "var(--color-olive-500)", "olive-600" => "var(--color-olive-600)", "olive-700" => "var(--color-olive-700)",
        "olive-800" => "var(--color-olive-800)", "olive-900" => "var(--color-olive-900)", "olive-950" => "var(--color-olive-950)",

        // Taupe
        "taupe-50" => "var(--color-taupe-50)", "taupe-100" => "var(--color-taupe-100)", "taupe-200" => "var(--color-taupe-200)", "taupe-300" => "var(--color-taupe-300)",
        "taupe-400" => "var(--color-taupe-400)", "taupe-500" => "var(--color-taupe-500)", "taupe-600" => "var(--color-taupe-600)", "taupe-700" => "var(--color-taupe-700)",
        "taupe-800" => "var(--color-taupe-800)", "taupe-900" => "var(--color-taupe-900)", "taupe-950" => "var(--color-taupe-950)",
