...
/// Create a reactive value from an explicit component context.
///
...
/// The context supplies both the scope and the [`ErrorHandler`] used for
/// deferred errors.
///
...
#[macro_export]
macro_rules! rx {
    ($context:expr; $($body:tt)*) => {
        $crate::__internal_rx!($crate; @context $context; $($body)*)
    };
}
