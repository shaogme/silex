...
pub struct LessAnalyzer;

const EXTENSIONS: &[&str] = &["less"];

impl LanguageAnalyzer for LessAnalyzer {
    fn descriptor(&self) -> LanguageDescriptor {
        LanguageDescriptor::new(LanguageId::Less, EXTENSIONS, &[])
    }
