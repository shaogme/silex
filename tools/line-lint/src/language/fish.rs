...
pub struct FishAnalyzer;

const EXTENSIONS: &[&str] = &["fish"];

impl LanguageAnalyzer for FishAnalyzer {
    fn descriptor(&self) -> LanguageDescriptor {
        LanguageDescriptor::new(LanguageId::Fish, EXTENSIONS, &[])
    }
