...
macro_rules! for_all_properties {
    ($callback:ident) => {
        $callback! {
            ...
            (border_bottom, "border-bottom", BorderBottom, Color),
            ...
            (border_left, "border-left", BorderLeft, Color),
            ...
            (border_right, "border-right", BorderRight, Color),
            ...
            (border_top, "border-top", BorderTop, Color),
