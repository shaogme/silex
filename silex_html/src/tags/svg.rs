...
silex_dom::define_tag!(Animate, "animate", animate, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(AnimateMotion, "animateMotion", animate_motion, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(AnimateTransform, "animateTransform", animate_transform, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Circle, "circle", circle, new_svg, void, [SvgTag]);
silex_dom::define_tag!(ClipPath, "clipPath", clip_path, new_svg, non_void, [SvgTag, TextTag]);
...
silex_dom::define_tag!(FeBlend, "feBlend", fe_blend, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeColorMatrix, "feColorMatrix", fe_color_matrix, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeComponentTransfer, "feComponentTransfer", fe_component_transfer, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeComposite, "feComposite", fe_composite, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeConvolveMatrix, "feConvolveMatrix", fe_convolve_matrix, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeDiffuseLighting, "feDiffuseLighting", fe_diffuse_lighting, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeDisplacementMap, "feDisplacementMap", fe_displacement_map, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeDistantLight, "feDistantLight", fe_distant_light, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeDropShadow, "feDropShadow", fe_drop_shadow, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeFlood, "feFlood", fe_flood, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeFuncA, "feFuncA", fe_func_a, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeFuncB, "feFuncB", fe_func_b, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeFuncG, "feFuncG", fe_func_g, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeFuncR, "feFuncR", fe_func_r, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeGaussianBlur, "feGaussianBlur", fe_gaussian_blur, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeImage, "feImage", fe_image, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeMerge, "feMerge", fe_merge, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeMergeNode, "feMergeNode", fe_merge_node, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeMorphology, "feMorphology", fe_morphology, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeOffset, "feOffset", fe_offset, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FePointLight, "fePointLight", fe_point_light, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeSpecularLighting, "feSpecularLighting", fe_specular_lighting, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeSpotLight, "feSpotLight", fe_spot_light, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeTile, "feTile", fe_tile, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(FeTurbulence, "feTurbulence", fe_turbulence, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Filter, "filter", filter, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(ForeignObject, "foreignObject", foreign_object, new_svg, non_void, [SvgTag, TextTag]);
...
silex_dom::define_tag!(LinearGradient, "linearGradient", linear_gradient, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Marker, "marker", marker, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Mask, "mask", mask, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Metadata, "metadata", metadata, new_svg, non_void, [SvgTag, TextTag]);
...
silex_dom::define_tag!(Pattern, "pattern", pattern, new_svg, non_void, [SvgTag, TextTag]);
...
silex_dom::define_tag!(RadialGradient, "radialGradient", radial_gradient, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Rect, "rect", rect, new_svg, void, [SvgTag]);
silex_dom::define_tag!(SvgScript, "script", svg_script, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Set, "set", set, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Stop, "stop", stop, new_svg, void, [SvgTag]);
silex_dom::define_tag!(SvgStyle, "style", svg_style, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Svg, "svg", svg, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Switch, "switch", switch, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Symbol, "symbol", symbol, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(Text, "text", text, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(TextPath, "textPath", text_path, new_svg, non_void, [SvgTag, TextTag]);
silex_dom::define_tag!(SvgTitle, "title", svg_title, new_svg, non_void, [SvgTag, TextTag]);
