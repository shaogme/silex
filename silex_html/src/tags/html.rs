...
impl AnchorAttributes for TypedElement<A> {
    fn href<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlAnchorElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_href(v)); self }
    fn target<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlAnchorElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_target(v)); self }
    fn rel<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlAnchorElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_rel(v)); self }
    fn download<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlAnchorElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_download(v)); self }
...
impl AnchorAttributes for TypedElement<Area> {
    fn href<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlAreaElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_href(v)); self }
    fn target<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlAreaElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_target(v)); self }
    fn rel<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlAreaElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_rel(v)); self }
    fn download<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlAreaElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_download(v)); self }
...
impl MediaAttributes for TypedElement<Audio> {
    fn src<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlAudioElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_src(v)); self }
    // width/height passed to attr for flexibility (%, px, auto)
    fn autoplay<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlAudioElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_autoplay(v)); self }
    fn controls<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlAudioElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_controls(v)); self }
    fn loop_<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlAudioElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_loop(v)); self }
    fn muted<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlAudioElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_muted(v)); self }
...
impl FormAttributes for TypedElement<Button> {
    ...
    fn value<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlButtonElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_value(v)); self }
    fn checked<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("checked", value) }
    fn disabled<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlButtonElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_disabled(v)); self }
    fn placeholder<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("placeholder", value) }
    fn readonly<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("readOnly", value) }
    fn required<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("required", value) }
    fn selected<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("selected", value) }
    fn multiple<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("multiple", value) }
...
impl OpenAttributes for TypedElement<Details> {
    fn open<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlDetailsElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_open(v)); self }
...
impl OpenAttributes for TypedElement<Dialog> {
    fn open<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlDialogElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_open(v)); self }
...
impl FormAttributes for TypedElement<Fieldset> {
    fn type_<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("type", value) }
    fn value<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.prop("value", value) }
    fn checked<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("checked", value) }
    fn disabled<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlFieldSetElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_disabled(v)); self }
    fn placeholder<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("placeholder", value) }
    fn readonly<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("readOnly", value) }
    fn required<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("required", value) }
    fn selected<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("selected", value) }
...
impl FormAttributes for TypedElement<Form> {
    ...
    fn value<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.prop("value", value) }
    fn checked<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("checked", value) }
    fn disabled<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("disabled", value) }
    fn placeholder<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("placeholder", value) }
    fn readonly<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("readOnly", value) }
    fn required<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("required", value) }
    fn selected<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("selected", value) }
...
impl MediaAttributes for TypedElement<Iframe> {
    fn src<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlIFrameElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_src(v)); self }
    // width/height passed to attr for flexibility (%, px, auto)

}
silex_dom::define_tag!(Img, "img", img, new, void, [MediaTag]);
impl MediaAttributes for TypedElement<Img> {
    fn src<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlImageElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_src(v)); self }
    // width/height passed to attr for flexibility (%, px, auto)

}
silex_dom::define_tag!(Input, "input", input, new, void, [FormTag]);
impl FormAttributes for TypedElement<Input> {
    fn type_<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlInputElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_type(v)); self }
    fn value<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlInputElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_value(v)); self }
    fn checked<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlInputElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_checked(v)); self }
    fn disabled<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlInputElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_disabled(v)); self }
    fn placeholder<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlInputElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_placeholder(v)); self }
    fn readonly<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlInputElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_read_only(v)); self }
    fn required<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlInputElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_required(v)); self }
    fn selected<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("selected", value) }
    fn multiple<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlInputElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_multiple(v)); self }
...
impl LabelAttributes for TypedElement<Label> {
    fn for_<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlLabelElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_html_for(v)); self }
...
impl AnchorAttributes for TypedElement<Link> {
    fn href<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlLinkElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_href(v)); self }
    fn target<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlLinkElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_target(v)); self }
    fn rel<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlLinkElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_rel(v)); self }
    fn download<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("download", value) }
...
impl FormAttributes for TypedElement<Optgroup> {
    ...
    fn value<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.prop("value", value) }
    fn checked<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("checked", value) }
    fn disabled<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlOptGroupElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_disabled(v)); self }
    fn placeholder<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("placeholder", value) }
    fn readonly<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("readOnly", value) }
    fn required<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("required", value) }
    fn selected<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("selected", value) }
...
silex_dom::define_tag!(OptionTag, "option", option, new, non_void, [TextTag, FormTag]);
impl FormAttributes for TypedElement<OptionTag> {
    fn type_<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("type", value) }
    fn value<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlOptionElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_value(v)); self }
    fn checked<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("checked", value) }
    fn disabled<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlOptionElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_disabled(v)); self }
    fn placeholder<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("placeholder", value) }
    fn readonly<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("readOnly", value) }
    fn required<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("required", value) }
    fn selected<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlOptionElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_selected(v)); self }
    fn multiple<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("multiple", value) }
...
impl FormAttributes for TypedElement<Output> {
    fn type_<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("type", value) }
    fn value<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlOutputElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_value(v)); self }
    fn checked<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("checked", value) }
    fn disabled<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("disabled", value) }
    fn placeholder<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("placeholder", value) }
    fn readonly<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("readOnly", value) }
...
impl FormAttributes for TypedElement<Select> {
    fn type_<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("type", value) }
    fn value<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlSelectElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_value(v)); self }
    fn checked<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("checked", value) }
    fn disabled<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlSelectElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_disabled(v)); self }
    fn placeholder<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("placeholder", value) }
    fn readonly<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("readOnly", value) }
    fn required<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlSelectElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_required(v)); self }
    fn selected<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("selected", value) }
    fn multiple<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlSelectElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_multiple(v)); self }
...
impl MediaAttributes for TypedElement<Source> {
    fn src<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlSourceElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_src(v)); self }
    // width/height passed to attr for flexibility (%, px, auto)
...
impl TableCellAttributes for TypedElement<Td> {
    fn colspan<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlTableCellElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| { if let Ok(n) = v.parse::<u32>() { el.set_col_span(n); } else { let _ = el.set_attribute("colspan", v); } }); self }
    fn rowspan<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlTableCellElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| { if let Ok(n) = v.parse::<u32>() { el.set_row_span(n); } else { let _ = el.set_attribute("rowspan", v); } }); self }
    fn headers<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlTableCellElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_headers(v)); self }
...
impl FormAttributes for TypedElement<Textarea> {
    fn type_<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { self.attr("type", value) }
    fn value<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlTextAreaElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_value(v)); self }
    fn checked<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("checked", value) }
    fn disabled<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlTextAreaElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_disabled(v)); self }
    fn placeholder<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlTextAreaElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_placeholder(v)); self }
    fn readonly<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlTextAreaElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_read_only(v)); self }
    fn required<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlTextAreaElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_required(v)); self }
    fn selected<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("selected", value) }
    fn multiple<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { self.prop("multiple", value) }
...
impl TableHeaderAttributes for TypedElement<Th> {
    fn scope<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlTableCellElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_scope(v)); self }
    fn abbr<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlTableCellElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_abbr(v)); self }
...
impl MediaAttributes for TypedElement<Track> {
    fn src<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlTrackElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_src(v)); self }
    // width/height passed to attr for flexibility (%, px, auto)
...
impl MediaAttributes for TypedElement<Video> {
    fn src<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyStringAttribute { let el: web_sys::HtmlVideoElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyStringAttribute; value.into_storable().apply_string(move |v| el.set_src(v)); self }
    // width/height passed to attr for flexibility (%, px, auto)
    fn autoplay<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlVideoElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_autoplay(v)); self }
    fn controls<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlVideoElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_controls(v)); self }
    fn loop_<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlVideoElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_loop(v)); self }
    fn muted<V>(self, value: V) -> Self where V: IntoStorable, V::Stored: silex_dom::ApplyBoolAttribute { let el: web_sys::HtmlVideoElement = self.element.dom_element.clone().unchecked_into(); use silex_dom::ApplyBoolAttribute; value.into_storable().apply_bool(move |v| el.set_muted(v)); self }
...
#[macro_export] macro_rules! option {
    () => { $crate::html::option(()) };
