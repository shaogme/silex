...
#[component]
fn AdvancedLayout(route: AdvancedRoute) -> impl Mount {
    div![
...
#[component]
fn CssLayout(route: CssRoute) -> impl Mount {
    div![
        h2("CSS & Styling"),
        p(
