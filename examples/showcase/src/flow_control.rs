...
pub fn ListDemo() -> impl View {
    let (list, set_list) = Signal::new(vec!["Apple", "Banana", "Cherry"]);
...
pub fn ShowDemo() -> impl View {
    let (visible, set_visible) = Signal::new(true);
...
pub fn DynamicDemo() -> impl View {
    let (mode, set_mode) = Signal::new("A");
...
pub fn IndexDemo() -> impl View {
    let (items, set_items) = Signal::new(vec!["Item A", "Item B", "Item C"]);
...
pub fn PortalDemo() -> impl View {
    let (show_modal, set_show_modal) = Signal::new(false);
